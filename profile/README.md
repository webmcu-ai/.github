...
| [github.com/webmcu-ai/on-device-sound](https://github.com/webmcu-ai/on-device-sound) | on-device sound machine learning model using FFT. Install the firmware on the xiao esp32s3 sense which has a microphone |
